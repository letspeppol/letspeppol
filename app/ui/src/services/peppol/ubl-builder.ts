    ...
    return joinNonEmpty(
        list.map((ac) =>
            joinNonEmpty([
                ...
                textElement('cbc:AllowanceChargeReasonCode', ac.AllowanceChargeReasonCode),
                textElement('cbc:AllowanceChargeReason', ac.AllowanceChargeReason),
                textElement('cbc:MultiplierFactorNumeric', ac.MultiplierFactorNumeric),
                buildAmount('cbc:Amount', ac.Amount),
                buildAmount('cbc:BaseAmount', ac.BaseAmount),
...
function buildInvoiceLine(line: InvoiceLine): string {
    return joinNonEmpty([
        ...
        buildAllowanceCharge(line.AllowanceCharge),
        buildItem(line.Item),
...
export function buildInvoiceXml(invoice: Invoice): string {
    const body = joinNonEmpty([
        ...
        buildAllowanceCharge(invoice.AllowanceCharge),
