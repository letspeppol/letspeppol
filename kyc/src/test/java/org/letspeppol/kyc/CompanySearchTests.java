...
class CompanySearchTests {
    ...
    void searchCompanies() {
        Company c1 = new Company("0208:1234567890", null, "BE1234567890", "Acme Corp");
        Company c2 = new Company("0208:0987654321", null, "BE0987654321", "Beta Inc");
        Company c3 = new Company("0208:1122334455", null, "BE1122334455", "Acme Limited");
        ...
        // Search by VAT
        results = companyService.search(null, "BE0987", null, null);
        assertThat(results).hasSize(1);
        assertThat(results.get(0).name()).isEqualTo("Beta Inc");

        // Search by Peppol ID
        results = companyService.search(null, null, "0208:1122", null);
        assertThat(results).hasSize(1);
