...
/**
 * Builds the JWT validator chain for resource servers: timestamps, required audience, and
 * (when configured) issuer. Audience binding ensures a token minted for these APIs cannot be
 * replayed against an unrelated audience.
 */
