...
/**
 * Builds the JWT validator chain for resource servers: timestamps, required audience, and issuer.
 * Audience binding ensures a token minted for these APIs cannot be
