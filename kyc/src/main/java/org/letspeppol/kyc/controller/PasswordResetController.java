...
public class PasswordResetController {
    ...
    @Operation(summary = "Change password while signed in", description = "Changes the password for the currently authenticated account using the existing access token.")
