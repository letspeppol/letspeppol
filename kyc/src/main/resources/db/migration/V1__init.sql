...
CREATE TABLE company (
    ...
    street                  varchar(255),
    business_unit           varchar(44),
    iban                    varchar(44),
    registered_on_peppol    boolean NOT NULL,
    suspended               boolean NOT NULL DEFAULT FALSE,
    has_kbo_address         boolean NOT NULL DEFAULT TRUE
);
...
CREATE INDEX idx_kbo_processed_zip_filename                 ON kbo_processed_zip(filename);
CREATE INDEX idx_company_business_unit_has_kbo_address      ON company(business_unit, has_kbo_address);
